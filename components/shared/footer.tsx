...
export const Footer: React.FC<Props> = ({ className }) => {
  return (
    <footer className={cn("border-t border-b bg-custom-dark", className)}>
      <Container className="flex items-center justify-between py-[45px]">
        <div className="w-full text-white">
          <div className="grid grid-cols-1 md:grid-cols-5">
            {/* Колонка "КАТАЛОГ" */}
            <div className="footer-column">
              <h4 className="text-lg font-bold mb-4">SushkaShop</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
                    className="relative bottom-2 text-gray-300 hover:text-gray-100"
                  >
                    О нас
                  </a>
                </li>
            ...
            <div className="footer-column">
              <h4 className="text-lg font-bold mb-4">Работа</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
            ...
            <div className="footer-column">
              <h4 className="text-lg font-bold mb-4">Партнерам</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
            ...
            <div className="footer-column">
              <h4 className="text-lg font-bold mb-4">Это интересно</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
            ...
            <div className="footer-column">
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
                    className="relative top-3 text-gray-300 hover:text-gray-100"
                  >
                    sushkashop@gmail.com
                  </a>
                </li>
              </ul>
            </div>

            <div className="footer-column mt-7">
              <h4 className="text-lg font-bold mb-4">5 042 234 234 ₽</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
                    className="relative bottom-2 text-gray-300 "
                  >
                    Выручка сети в этом месяце. <br />
                    В прошлом - 4 229 234 199 ₽
                  </a>
                </li>
              </ul>
            </div>
            <div className="footer-column relative mt-7 left-9">
              <h4 className="text-lg font-bold mb-4">467 Заведений</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
          ...
          {/* Нижняя часть футера */}
          <div className="my-[45px] relative bottom-5 border-t border-custom-gray flex justify-between items-center">
          </div>
        
         <div className="flex gap-4">
            <div className="footer-column">
              <h4 className="text-gray-300 font-normal relative bottom-8">SushkaShop</h4>
            </div>
            <div className="footer-column">
              <h4 className="text-gray-300 font-normal relative bottom-8">© 2025</h4>
            </div>
            <div className="footer-column">
              <h4 className="text-gray-300 font-normal relative bottom-8">Правовая информация</h4>
            </div>
            <div className="footer-column">
              <h4 className="text-gray-300 font-normal relative bottom-8">Калорийность и состав</h4>
            </div>
            <div className="footer-column">
              <h4 className="text-gray-300 font-normal relative bottom-8">Помощь</h4>
            </div>
         </div> 
         <div className="text-custom-black leading-4 text-sm relative bottom-6">
            <p>© 2025 OOO SushkaShop</p>
            <p>ОГРН 1131101001844, ИНН 1101140415</p>
            <p>167001, Павлодарская обл., г. Экибастуз, выдуманная 81, д.42</p>
         </div>
        </div>
      </Container>
    </footer>
