        ...
        <div className='flex justify-center flex-col max-w-[280px] min-h-[260px] max-h-[440px] my-5 group'>
            <Link href={`/product/${id}`}>
                <div className="  p-3  rounded-md bg-gray-100 ">
                    <Image src={imageUrl} alt="" width={280} height={280} className='w-[250px] h-[250px] group-hover:-translate-y-1 transition duration-300' />
                </div>
                <h2 className='text-lg font-bold mt-3'>{name}</h2>
                <p className='text-sm text-gray-400 flex flex-wrap my-3'>
